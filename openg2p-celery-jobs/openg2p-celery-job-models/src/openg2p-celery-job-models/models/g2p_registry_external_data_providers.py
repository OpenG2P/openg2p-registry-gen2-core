...
class G2PRegistryExternalDataProvider(BaseORMModel):

    __tablename__ = "g2p_registry_external_data_providers"
    ...
    helper_code: Mapped[str] = mapped_column(String, nullable=False)
